       ...
       @endif
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <form method="POST" action="{{ route('result.course_update',['id' => $studentinfo[0]->ref, 'course' => $studentinfo[0]->my_course[0]->id])}}">
                @csrf
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="course"   value="{{ $studentinfo[0]->my_course[0]->course_name}}" class="form-control"  >
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" name="mark" value="{{ $studentinfo[0]->my_course[0]->mark}}"  min="0" max="100" class="form-control" >
                    </div>
                  </div>
